...
def on_delete_entry(exception: Exception, base_function_name: str):
    ...
    def on_key_error():
        """Preset or skin entry no longer exists (stale combo)."""
        _QMB.warning(
            _parent, "Entry Not Found",
            "The selected entry was not found in the database.\n"
